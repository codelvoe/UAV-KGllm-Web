...
#from .anti_uav import QueryConvGate, DSRPN, VersatileRCNNHead, SiamTwoStage

from .qsiam import QueryConvGate, SiamDetect

from .vis_smalluav import VMRDBlock, EdgeGradientAttention
